...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>		
		<div class="formContainer" id="registerFormContainer">
			<form id="registerForm" method="POST" action="/r/submitAdminPassword" onsubmit="return verifyPassword();">
				<div class="formRow inputRow">
					<span class="formLabel emailLabel">Username:</span>  <span class="readOnlyFormText">admin</span>
				</div>
				<div class="formRow inputRow">
