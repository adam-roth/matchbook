	...
	public void run() {
		while (! stop) {
			try {
				...
				//"__iappsMatchData":{"password":null,"uuid":"6e7927a6-a5e7-4355-b0fa-0bf9a91ed90c","matchId":"6"}
				JSONObject internalData = (JSONObject)handshakePacket.get("__iappsMatchData");
