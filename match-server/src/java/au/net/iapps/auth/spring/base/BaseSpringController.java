package au.net.iapps.auth.spring.base;
...
public abstract class BaseSpringController extends DispatcherServlet {
	...
	private static class LogFilter extends Filter {
		...
		public int decide(LoggingEvent event) {
			...
			if (event.getLocationInformation().getClassName().contains("au.net.iapps")) {
				//log all iapps messages
				return ACCEPT;
			}
