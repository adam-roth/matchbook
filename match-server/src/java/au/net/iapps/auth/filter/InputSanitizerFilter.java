package au.net.iapps.auth.filter;
...
public class InputSanitizerFilter implements Filter {
	...
	public static final String QUARANTINE_ATTRIBUTE_NAME = "iapps.auth.quarantined.params";
	public static final String SUSPICIOUS_REQUEST_FLAG_NAME = "iapps.auth.suspicious.request";
